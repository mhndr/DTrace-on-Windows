...
typedef struct dtrace_mstate {
	...
	uint64_t dtms_arg[4];			/* cached arguments */
	void* dtms_context;			/* call context */
...
#ifdef _WIN32
extern ulong_t dtrace_getreg(struct _KTRAP_FRAME*, struct _CONTEXT*, uint_t);
#else
