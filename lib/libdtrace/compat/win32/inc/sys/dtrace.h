...
#define	DTRACEOPT_SYMPATH	32	/* symbol search path */
...
#define	DTRACE_RECORD_STORE_TIMESTAMP(dtrh, hrtime) {		\
	...
	(dtrh)->dtrh_timestamp_hi = (uint32_t)(hrtime >> 32);	\
}
 ...
 *   1.9.1). The fifth argument is a context passed to the
 *   dtrace_probe() itself. This argument may
 ...
 *   dtrace_probe_create() or dtrace_probe_lookup().  The second through fifth
 *   arguments are the values to which the D variables "arg0" through "arg3"
 *   will be mapped. Sixth argument is a call-specific context to be passed to
 *   the get arg callback.
 *
...
typedef struct dtrace_pops {
#ifdef _WIN32
	void (*dtps_provide)(void *arg, const char *, const char *,
...
#ifdef _WIN32
	int (*dtps_getargdesc)(void *arg, dtrace_id_t id, void *parg,
	    int ndx, char* type_name, size_t type_name_len);
#else
	...
	uint64_t (*dtps_getargval)(void *arg, dtrace_id_t id, void *parg,
	    int argno, void* ctx);
#ifdef _WIN32
	KPROCESSOR_MODE (*dtps_getframe)(void *arg, dtrace_id_t id, void *parg, void* ctx,
	    struct _KTRAP_FRAME** trap_frame, struct _CONTEXT** context_record);
#else
	int (*dtps_usermode)(void *arg, dtrace_id_t id, void *parg, void* ctx);
#endif
